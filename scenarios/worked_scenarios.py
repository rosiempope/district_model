...
FOUR_PIPE_ASHP_GAS["cooling_sources"] = [
    {"type":"air_cooled_chiller", "preset":"generic_2MW_bank", "name":"Central chiller bank", "capacity_MW":5.2, "n_units":6, "chilled_water_temp_C":6.0},
]

# Only service-compliant design alternatives are shown in the default option
# comparison. ASHP_ONLY is retained as an explicit diagnostic/stress fixture,
# not as an investable alternative.
WORKED_SCENARIOS=[GAS_ONLY,ASHP_PLUS_GAS_PEAK,DATACENTRE_PLUS_BOOSTER,EFW_PLUS_ASHP,FOUR_PIPE_ASHP_GAS]
DIAGNOSTIC_SCENARIOS=[ASHP_ONLY]
