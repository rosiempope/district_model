...
|:------------------------------|:--------------------------------------------|---------------------------------:|:--------------|------------------:|--------------------:|:---------------------|
| Central Exeter (dense core)   | Gas-only reference                          |                            2.853 | FAIL          |              0    |              -20.54 | FAIL                 |
| Central Exeter (dense core)   | ASHP + gas peak                             |                            2.853 | PASS          |              5.49 |              -33.72 | FAIL                 |
| Central Exeter (dense core)   | Data-centre waste heat + booster + gas peak |                            2.853 | PASS          |              4.55 |              -30.81 | FAIL                 |
| Central Exeter (dense core)   | EfW heat export + ASHP + gas peak           |                            2.853 | PASS          |              5.61 |              -23.82 | FAIL                 |
| Sowton / Airport / East Devon | Gas-only reference                          |                            1.441 | FAIL          |              0    |              -24.51 | FAIL                 |
| Sowton / Airport / East Devon | ASHP + gas peak                             |                            1.441 | PASS          |              5.64 |              -32.81 | FAIL                 |
| Sowton / Airport / East Devon | Data-centre waste heat + booster + gas peak |                            1.441 | FAIL          |              0    |              -35.23 | FAIL                 |
| Sowton / Airport / East Devon | EfW heat export + ASHP + gas peak           |                            1.441 | PASS          |              5.64 |              -25.46 | FAIL                 |

- **Best case found: Central Exeter (dense core) — EfW heat export + ASHP + gas peak** (NPV £-23.82m, GHNF grant £5.61m, screening: FAIL). EfW + ASHP + gas peak is the only technology that clears the carbon gate on both networks and earns a grant in both — consistently the strongest option here, same as the earlier Dalkia screening study on the illustrative archetypes.
...
|:--------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------------------|------------------------------------------------:|-------------------------------------:|------------------------------------:|
| ASHP + gas peak                             | not reached in swept range                              | not reached in swept range                                    |                                            35.5 |                                 44.5 |                                 4.8 |
| Data-centre waste heat + booster + gas peak | not reached in swept range                              | not reached in swept range                                    |                                            32.3 |                                 44.5 |                                 4.4 |
| EfW heat export + ASHP + gas peak           | not reached in swept range                              | not reached in swept range                                    |                                            26.4 |                                 44.5 |                                 3.6 |
...
|:--------------------------------------------|--------------------------------:|-----------------------------------:|:-----------------------|-------------:|
| Gas-only reference                          |                          -24.51 |                             -44.34 | worse                  |       -19.83 |
| ASHP + gas peak                             |                          -32.81 |                             -51.74 | worse                  |       -18.94 |
| Data-centre waste heat + booster + gas peak |                          -35.23 |                             -48.54 | worse                  |       -13.31 |
| EfW heat export + ASHP + gas peak           |                          -25.46 |                             -44.25 | worse                  |       -18.79 |
