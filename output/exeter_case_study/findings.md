...
|:------------------------------|:--------------------------------------------|---------------------------------:|:--------------|------------------:|--------------------:|:---------------------|
| Central Exeter (dense core)   | Gas-only reference                          |                            2.853 | FAIL          |              0    |              -20.74 | FAIL                 |
| Central Exeter (dense core)   | ASHP + gas peak                             |                            2.853 | PASS          |              5.49 |              -33.92 | FAIL                 |
| Central Exeter (dense core)   | Data-centre waste heat + booster + gas peak |                            2.853 | PASS          |              4.55 |              -31    | FAIL                 |
| Central Exeter (dense core)   | EfW heat export + ASHP + gas peak           |                            2.853 | PASS          |              5.61 |              -24.01 | FAIL                 |
| Sowton / Airport / East Devon | Gas-only reference                          |                            1.441 | FAIL          |              0    |              -26.24 | FAIL                 |
| Sowton / Airport / East Devon | ASHP + gas peak                             |                            1.441 | PASS          |              5.64 |              -34.53 | FAIL                 |
| Sowton / Airport / East Devon | Data-centre waste heat + booster + gas peak |                            1.441 | FAIL          |              0    |              -36.96 | FAIL                 |
| Sowton / Airport / East Devon | EfW heat export + ASHP + gas peak           |                            1.441 | PASS          |              5.64 |              -27.19 | FAIL                 |

- **Best case found: Central Exeter (dense core) — EfW heat export + ASHP + gas peak** (NPV £-24.01m, GHNF grant £5.61m, screening: FAIL). EfW + ASHP + gas peak is the only technology that clears the carbon gate on both networks and earns a grant in both — consistently the strongest option here, same as the earlier Dalkia screening study on the illustrative archetypes.
...
|:--------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------------------|------------------------------------------------:|-------------------------------------:|------------------------------------:|
| ASHP + gas peak                             | not reached in swept range                              | not reached in swept range                                    |                                            36   |                                 44.5 |                                 4.9 |
| Data-centre waste heat + booster + gas peak | not reached in swept range                              | not reached in swept range                                    |                                            32.8 |                                 44.5 |                                 4.5 |
| EfW heat export + ASHP + gas peak           | not reached in swept range                              | not reached in swept range                                    |                                            26.9 |                                 44.5 |                                 3.7 |
...
|:--------------------------------------------|--------------------------------:|-----------------------------------:|:-----------------------|-------------:|
| Gas-only reference                          |                          -26.24 |                             -46.07 | worse                  |       -19.83 |
| ASHP + gas peak                             |                          -34.53 |                             -53.47 | worse                  |       -18.94 |
| Data-centre waste heat + booster + gas peak |                          -36.96 |                             -50.27 | worse                  |       -13.31 |
| EfW heat export + ASHP + gas peak           |                          -27.19 |                             -45.98 | worse                  |       -18.79 |
