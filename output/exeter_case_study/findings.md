...
|:------------------------------|:--------------------------------------------|---------------------------------:|:--------------|------------------:|--------------------:|:---------------------|
| Central Exeter (dense core)   | Gas-only reference                          |                            2.853 | FAIL          |              0    |              -18.46 | FAIL                 |
| Central Exeter (dense core)   | ASHP + gas peak                             |                            2.853 | PASS          |              5.49 |              -31.64 | FAIL                 |
| Central Exeter (dense core)   | Data-centre waste heat + booster + gas peak |                            2.853 | PASS          |              4.55 |              -28.73 | FAIL                 |
| Central Exeter (dense core)   | EfW heat export + ASHP + gas peak           |                            2.853 | PASS          |              5.61 |              -21.74 | FAIL                 |
| Sowton / Airport / East Devon | Gas-only reference                          |                            1.441 | FAIL          |              0    |              -23.46 | FAIL                 |
| Sowton / Airport / East Devon | ASHP + gas peak                             |                            1.441 | PASS          |              5.64 |              -31.76 | FAIL                 |
| Sowton / Airport / East Devon | Data-centre waste heat + booster + gas peak |                            1.441 | FAIL          |              0    |              -34.18 | FAIL                 |
| Sowton / Airport / East Devon | EfW heat export + ASHP + gas peak           |                            1.441 | PASS          |              5.64 |              -24.41 | FAIL                 |

- **Best case found: Central Exeter (dense core) — EfW heat export + ASHP + gas peak** (NPV £-21.74m, GHNF grant £5.61m, screening: FAIL). EfW + ASHP + gas peak is the only technology that clears the carbon gate on both networks and earns a grant in both — consistently the strongest option here, same as the earlier Dalkia screening study on the illustrative archetypes.
...
|:--------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------------------|------------------------------------------------:|-------------------------------------:|------------------------------------:|
| ASHP + gas peak                             | not reached in swept range                              | not reached in swept range                                    |                                            33.6 |                                 44.5 |                                 4.6 |
| Data-centre waste heat + booster + gas peak | not reached in swept range                              | not reached in swept range                                    |                                            30.5 |                                 44.5 |                                 4.2 |
| EfW heat export + ASHP + gas peak           | not reached in swept range                              | not reached in swept range                                    |                                            24.6 |                                 44.5 |                                 3.4 |
...
|:--------------------------------------------|--------------------------------:|-----------------------------------:|:-----------------------|-------------:|
| Gas-only reference                          |                          -23.46 |                             -42.45 | worse                  |       -18.98 |
| ASHP + gas peak                             |                          -31.76 |                             -49.85 | worse                  |       -18.09 |
| Data-centre waste heat + booster + gas peak |                          -34.18 |                             -46.64 | worse                  |       -12.46 |
| EfW heat export + ASHP + gas peak           |                          -24.41 |                             -42.36 | worse                  |       -17.95 |
