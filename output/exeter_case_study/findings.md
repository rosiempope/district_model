...
|:------------------------------|:--------------------------------------------|---------------------------------:|:--------------|------------------:|--------------------:|:---------------------|
| Central Exeter (dense core)   | Gas-only reference                          |                            2.853 | FAIL          |              0    |              -19.29 | FAIL                 |
| Central Exeter (dense core)   | ASHP + gas peak                             |                            2.853 | PASS          |              5.49 |              -32.47 | FAIL                 |
| Central Exeter (dense core)   | Data-centre waste heat + booster + gas peak |                            2.853 | PASS          |              4.55 |              -29.55 | FAIL                 |
| Central Exeter (dense core)   | EfW heat export + ASHP + gas peak           |                            2.853 | PASS          |              5.61 |              -22.56 | FAIL                 |
| Sowton / Airport / East Devon | Gas-only reference                          |                            1.441 | FAIL          |              0    |              -23.33 | FAIL                 |
| Sowton / Airport / East Devon | ASHP + gas peak                             |                            1.441 | PASS          |              5.64 |              -31.63 | FAIL                 |
| Sowton / Airport / East Devon | Data-centre waste heat + booster + gas peak |                            1.441 | FAIL          |              0    |              -34.05 | FAIL                 |
| Sowton / Airport / East Devon | EfW heat export + ASHP + gas peak           |                            1.441 | PASS          |              5.64 |              -24.28 | FAIL                 |

- **Best case found: Central Exeter (dense core) — EfW heat export + ASHP + gas peak** (NPV £-22.56m, GHNF grant £5.61m, screening: FAIL). EfW + ASHP + gas peak is the only technology that clears the carbon gate on both networks and earns a grant in both — consistently the strongest option here, same as the earlier Dalkia screening study on the illustrative archetypes.
...
Route length was swept from 250 m to 19,000 m on the Central network's own demand, holding the building portfolio fixed, to trace required break-even tariff against linear heat density — then checked against two fixed reference rates: the live Ofgem household gas cap (**7.33 p/kWh**) and this portfolio's own modelled gas-parity bill (**~8.8 p/kWh**).

| Technology                                  | Density needed for break-even @ Ofgem cap (7.33p/kWh)   | Density needed for break-even @ modelled parity (~8.8p/kWh)   |   Min. required tariff reached in sweep (p/kWh) |   ...at max swept density (MWh/m/yr) |   Still x Ofgem cap at that density |
|:--------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------------------|------------------------------------------------:|-------------------------------------:|------------------------------------:|
| ASHP + gas peak                             | not reached in swept range                              | not reached in swept range                                    |                                            35   |                                 44.5 |                                 4.8 |
| Data-centre waste heat + booster + gas peak | not reached in swept range                              | not reached in swept range                                    |                                            31.9 |                                 44.5 |                                 4.4 |
| EfW heat export + ASHP + gas peak           | not reached in swept range                              | not reached in swept range                                    |                                            25.9 |                                 44.5 |                                 3.5 |
...
|:--------------------------------------------|--------------------------------:|-----------------------------------:|:-----------------------|-------------:|
| Gas-only reference                          |                          -23.33 |                             -41.36 | worse                  |       -18.03 |
| ASHP + gas peak                             |                          -31.63 |                             -48.76 | worse                  |       -17.13 |
| Data-centre waste heat + booster + gas peak |                          -34.05 |                             -45.56 | worse                  |       -11.51 |
| EfW heat export + ASHP + gas peak           |                          -24.28 |                             -41.27 | worse                  |       -16.99 |
...
---
Generated by `analysis/exeter_case_study.py`; all figures reproducible by re-running that script. See `MODEL_SUMMARY.md` §12 for what this screening tool does and does not prove.