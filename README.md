# district_model
techno-economic model of district heating (and maybe cooling) for UK building context - using Ealing town centre project as case study and data collection: https://zerocarbonaccelerator.london/wp-content/uploads/2025/07/Ealing-Town-Centre-Heat-Network-Feasibility-Report.pdf
...
Dalkia asked the team to investigate large-scale heat pumps integrated with
...
Weather & climate data — done. Parses a real 20-year TMYx weather
file for London Heathrow into a clean hourly dataset, with optional
2050 climate-change scenarios layered on top.
Demand profiles — done. Turns annual benchmark energy use (CIBSE-
...
schools, hotels).
Heat sources — done. Four source technologies, each built so you
...
Dispatch & network sizing — in progress. Decides, hour by hour,
...
after that works.
Economics — not yet started. Turns the dispatch and network outputs
...
bashpython3 components/source.py
