...
CAPEX_BASIS = {
    ...
    "energy_centre_building_GBP":  ("fixed",          "Flat £ as entered here — see note on scaling"),
    "land_and_enabling_GBP":       ("fixed",          "Flat £ as entered here — see note on scaling"),
    "electricity_connection_GBP":  ("fixed",          "Flat £ as entered here — see note on scaling"),
    "gas_connection_GBP":          ("fixed",          "Flat £ as entered here — see note on scaling"),
    "controls_and_scada_GBP":      ("fixed",          "Flat £ as entered here — see note on scaling"),
    "development_and_design_GBP":  ("% adder",        "% of whole delivered scope except land"),
    "commissioning_GBP":           ("% adder",        "% of whole delivered scope except land"),
    "contingency_GBP":             ("% adder",        "% of whole delivered scope except land"),
}
